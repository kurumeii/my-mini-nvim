...
k.set('n', '<C-->', 'zC', { desc = "Close fold under cursor", noremap = true })
k.set('n', '-', 'zo', { desc = "Open all folds under cursor", noremap = true })
k.set('n', '<C->=', 'zO', { desc = "CLose all folds under cursor", noremap = true })
